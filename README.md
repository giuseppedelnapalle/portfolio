...
* Robust to common gene expression normalisation and transformation methods, such as CPM, log CPM, so long as the rank data is preserved.
...
* [Preprint accessible](https://doi.org/10.51094/jxiv.580).
...
* Linear dimensional reduciton, clustering, and non-linear dimensional reduction were performed to discover the key characteristics and local relationships of the cells in the dataset.
